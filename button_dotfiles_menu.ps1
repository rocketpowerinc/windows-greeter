$window.FindName("DotfilesButton").Add_Click({
  ...
  $backButton.Add_Click({
      # Optionally, create the main menu again and replace the content
      $window.Content = $mainMenuGrid  # This assumes you have stored the main menu grid previously in $mainMenuGrid
  })
