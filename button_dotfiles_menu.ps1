...
$refresh_Dotfiles_Button.Background = [System.Windows.Media.Brushes]::Green  # Set background color
$refresh_Dotfiles_Button.Foreground = [System.Windows.Media.Brushes]::White  # Set text color
...
$refresh_Dotfiles_Button.Add_Click({
    ...
    # Add logic for refreshing dotfiles
  })
...
$copy_Default_Powershell_Profile_Button.Add_Click({
    ...
    # Add logic for copying Default Powershell profile
  })
