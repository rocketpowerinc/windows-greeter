...
$refresh_Dotfiles_Button.Margin = "10,1,10,1"  # Reduced vertical margin to almost touch
...
$copy_PWSH_Profile_Button.Margin = "10,1,10,1"  # Reduced vertical margin to almost touch
...
$copy_Default_Powershell_Profile_Button.Margin = "10,1,10,1"  # Reduced vertical margin to almost touch
...
$copy_WSL_Bash_Dotfile_Button.Margin = "10,1,10,1"  # Reduced vertical margin to almost touch
...
$backButton.Margin = "10,5,10,1"  # Slightly larger top margin for separation
